      ...
      <nav className="navbar navbar-expand-lg py-3">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav text-center mr-auto">     
            ...
            <input className="roastrLink col-12 col-xs-12 col-lg-1 py-2 mr-3 mr-0 text-center" onClick={this.myFunction} id="myInput" type="text" value="https://roastr-app.herokuapp.com/"/>
