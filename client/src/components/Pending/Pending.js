...
const Pending = function(props) {
    ...
    return(
      ...
      <div className="row border-bottom justify-content-between p-1">
        ...
        <div>
            <button type="button" class="btn btn-primary mt-1" data-toggle="modal" data-whatever={props.roast} onClick={()=>props.changeRoast(props.roast)} data-target="#pendingModal">View</button>
