    ...
    return (
      <div>
        ...
        <div className="row p-3">
          ...
          <div className="col-10 col-xs-8 col-sm-8 offset-sm-2 col-md-3 col-lg-3 col-xl-2 mx-auto">
            <User />
          </div>
          ...
          <div className="col-sm-12 col-md-9 offset-md-3 col-lg-3 offset-lg-0 col-xl-3">
            <Social />
          </div>
